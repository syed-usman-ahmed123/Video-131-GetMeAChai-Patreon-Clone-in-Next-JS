    ...
    <nav className='bg-slate-900 text-white flex justify-between px-4 h-16 items-center'>
      ...
      <div className='relative'>
        {session && <>
          ...
          {/* <!-- Dropdown menu --> */}
          <div id="dropdown" className={`z-10 ${showdropdown ? "" : "hidden"} absolute left-[130px] bg-white divide-y  divide-gray-100 rounded-lg shadow-sm w-44 dark:bg-gray-700`}>
